...
#define UNDEF   0xFE //UNDEF_OP
#define NOP     0xFF //NO_OP

// SPI trnasfers length

#define STA_LEN     0 //R_STATUS_LEN
#define WRC_LEN    10 //W_RF_CONFIG_LEN
#define RRC_LEN    10 //R_RF_CONFIG_LEN
#define WTP_LEN    16 //W_TX_PAYLOAD_LEN
#define RTP_LEN    16 //R_TX_PAYLOAD_LEN
#define WTA_LEN     4 //W_TX_ADDRESS_LEN
#define RTA_LEN     4 //R_TX_ADDRESS_LEN
#define RRP_LEN    16 //R_RX_PAYLOAD_LEN
#define UNDEF_LEN  99 //UNDEF_LEN
